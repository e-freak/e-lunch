defmodule LunchOrder.UsersTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{email: "some email", name: "some name", organization: "some organization", password: "some password", user_id: "some user_id"}
    @update_attrs %{email: "some updated email", name: "some updated name", organization: "some updated organization", password: "some updated password", user_id: "some updated user_id"}
    @invalid_attrs %{email: nil, name: nil, organization: nil, password: nil, user_id: nil}
